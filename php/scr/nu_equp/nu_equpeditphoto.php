...
?>
                                ...
                                <table width="575" height="19" border="0" cellpadding="1" cellspacing="1">
								  ...
								  <form method="post" action="nu_equpeditphotosave.php" enctype="multipart/form-data" name="webFormSearch" onSubmit="return checksearch()">
                                    ...
                                    <tr bgcolor="#FFFFFF"> 
									  ...
									  <br>
									   <input name="equpphoto" type="file" class="input" id="equpphoto" size="40">
