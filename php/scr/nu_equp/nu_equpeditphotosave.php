...
if($_FILES["equpphoto"]["name"] != "")
{
$name=$_FILES['equpphoto']['name'];
$tmp=$_FILES['equpphoto']["tmp_name"];
...
$sql_data = "update nu_equps set info1='$_POST[info1]',info2='$_POST[info2]',info3='$_POST[info3]',info4 = '$_POST[info4]',info5='$_POST[info5]',info6='$_POST[info6]',equpphoto='$photo_3' where id = '$_POST[idx]'";
