  ...
  if( prd1.length ==0)
           ...
           return true;
                                ...
                                <table width="1000" height="19" border="0" cellpadding="1" cellspacing="1">
								  ...
								  <form method="post" action="nu_equpsave.php" enctype="multipart/form-data" name="webFormSearch" onSubmit="return checksearch()">
                                    ...
                                    <tr bgcolor="#FFFFFF"> 
                                      <td width="160"> <div align="right"><font size="2">Unit Price  
                                          :</font></div></td>
                                      <td width="501"><font size="3"> 
                                        <input name="equpprice" type="text" id="equpprice" class="input" size="5">
                                        </font></td>
                                    </tr>                                    
                                    ...
                                    <tr bgcolor="#FFFFFF"> 
									  ...
									  &nbsp;&nbsp;&nbsp;&nbsp;<a href="nu_equp.php"><font face="tahoma" >Cancel</font></a>
									  </td>
                                    </tr>
                                  </form>
                                </table>
