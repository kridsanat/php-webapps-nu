...
<form method="post" action="nu_equpedit.php?SerID=<?php echo "$idx"; ?>">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			if ($infono == 'HQ.Jatuchot')
			  {
			  	echo "<td bgcolor='#4682B4' width='14%' ><font face= 'tahoma' color='#fff3e0' size='+2'><b>&nbsp;&nbsp;HQ.Jatuchot</b></font></td>";
			}else if ($infono == 'Factory.TIP9')
			  {
				echo "<td bgcolor='#3CB371' width='14%' ><font face= 'tahoma' color='#fff3e0' size='+2'><b>&nbsp;&nbsp;Factory.TIP9</b></font></td>";
			...
			{
			  echo "<td bgcolor='#9292D1' width='14%' ><font face= 'tahoma' color='#fff3e0' size='+2'><b>&nbsp;&nbsp;Site.Nirvana</b></font></td>";
			}else if ($infono == 'Site.UM')
			{
			  echo "<td bgcolor='#8FBC8F' width='14%' ><font face= 'tahoma' color='#fff3e0' size='+2'><b>&nbsp;&nbsp;Site.UM</b></font></td>";
			}else if ($infono == 'Site.WHN')
			{
			  echo "<td bgcolor='#B03060' width='14%' ><font face= 'tahoma' color='#fff3e0' size='+2'><b>&nbsp;&nbsp;Site.WHN</b></font></td>";
			
			}else if ($infono == 'Site.Nirvana2')
			{
			  echo "<td bgcolor='#9c27b0' width='14%' ><font face= 'tahoma' color='#fff3e0' size='+2'><b>&nbsp;&nbsp;Site.Nirvana2</b></font></td>";
			...
			}else if ($infono == 'Site.Bangpoo')
			{
			  ...
			  {
				echo "<td bgcolor='#66CCCC' width='14%' ><font face= 'tahoma' color='#fff3e0' size='+2'><b>&nbsp;&nbsp;$infono</b></font></td>";
			}
