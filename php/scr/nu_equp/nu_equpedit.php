...
<?php
$sql_1="select * from nu_equps where id = '$_GET[SerID]'";
...
$info5 =$result1['info5'];
$info6 =$result1['info6'];
$equpprice =$result1['equpprice'];
$equpphoto =$result1['equpphoto'];
								  ...
								  <form method="post" action="nu_equpeditsave.php" enctype="multipart/form-data" name="webFormSearch" onSubmit="return checksearch()">
                                    <tr bgcolor="#FFFFFF" width="300" > 
                                      <td> <div align="right"><font size="2">Update Picture
                                          :</font></div></td>
                                      <td>
									  <?php echo "<img src=../pic/$equpphoto width=55 height=55 border=1 >"; ?>
									  <br>
									  <a href="nu_equpeditphoto.php?SerID=<?php echo "$idx"; ?>" >Change Picture</a>
                                    ...
                                    <tr bgcolor="#FFFFFF"> 
                                      ...
                                      <td width="501"><font size="3"> 
                                        <input name="equpprice" type="text" id="equpprice" class="input" size="5" value='<?php echo "$equpprice"; ?>'>
                                        </font></td>
                                    </tr>   									
									 <tr bgcolor="#FFFFFF"> 
									...
									<tr bgcolor="#FFFFFF"> 
                                      ...
                                      <td><font size="3"> 
										...
										<textarea name="info6" type="text" id="" id="info6"  cols="120" rows="30"><?php echo $info6; ?></textarea>
                                        </font></td>
                                    </tr>									
					  ...
					  echo "
						...
						?>
									...
									<tr bgcolor="#FFFFFF"> 
									  ...
									  &nbsp;&nbsp;&nbsp;&nbsp;<a href="nu_equp.php"><font face="tahoma" color="#000033" size="2">Cancel</font></a>
									  </td>
                                    </tr>
