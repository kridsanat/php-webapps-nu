...
if (mysqli_num_rows($fect) == 0) {
    ...
    while ($rows = mysqli_fetch_array($fect)) {
        ...
        echo "<tr style='background-color: $bgcolor;'>
                <td>" . $rows["infono"] . "</td><td bgcolor='#4682B4' width='14%' ><font face= 'tahoma' color='#FFFACD' size='+1'><b>&nbsp;&nbsp;$infono</b></font></td>
                <td>" . $info1 . "</td>
                <td>" . $rows["info2"] . "</td>
                <td>" . $printsprice . "</td>
                <td><img src=../pic/$printsphoto width=50 height=50 border=1 ></td>
              </tr>";
        $bgcount++;
    }
    echo "</table>";
