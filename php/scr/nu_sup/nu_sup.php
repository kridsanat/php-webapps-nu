...
$select_type="select * from nu_sup order by info5, infono, info1, info4 asc";
...
echo "<br><br><center><font color=#666666 face=tahoma size=2><b>No item</b></font></center>";
		...
		$select="select * from nu_sup order by info5, infono, info1, info4 asc";
...
$sql_select_mem="Select * From nu_sup order by info5, infono, info1, info4 asc limit $goto,$pagesize";
								...
								<td bgcolor="#FFFFFF" width="2%" valign="center"  >
									...
									<a href="<?php echo "../pic/$supphoto"; ?>" rel="lightbox" target="_blank" style="text-decoration: none;" >
										...
										<?php
							 			 if ($supphoto >= 100)
							  			{
							 			echo "<img src=../pic/$supphoto width=15 height=15 border=1 >";
							 			}else
										{
			...
			?>
							...
							<td width="10%" bgcolor='#AFEEEE' align="left" >
								...
								<?php echo "<font face=tahoma size=2 color=#	><b>$info3</b></font>"; ?>
									...
									if ($status == "Active")
					 				{
									  echo "<td width='0.5%' align='center' bgcolor='green'></td>";
									}else if ($status == "Deactive")
									{
									  echo "<td width='0.5%' align='center' bgcolor='red'></td>";
									}						
									?>
								...
								<td bgcolor="#ffffff" width="28%" valign="top" >
											
									
								&nbsp;<input name='submit' type='submit' class='submit' value='Edit' >&nbsp;
								<i><b><?php echo "<font face=tahoma size=4 color=#006699 >$info4 </font>"; ?></b></i>
			...
			if ($info5 == 'PRD')
			...
			}else if ($info5 == 'DEV')
			  {
				echo "<td bgcolor='#3CB371' width='3%' ><font face= 'tahoma' color='#FFFACD' size='2'><b>&nbsp;&nbsp;DEV</b></font></td>";
								...
								<td width="17%" bgcolor='#FFFFFF' align="left">
