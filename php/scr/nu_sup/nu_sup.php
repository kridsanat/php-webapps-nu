...
$select_type="select * from nu_sup order by info4, info1 asc";
...
echo "<br><br><center><font color=#666666 face=tahoma size=2><b>No item</b></font></center>";
		...
		$select="select * from nu_sup order by info4, info1 asc";
...
$sql_select_mem="Select * From nu_sup order by info4, info1 asc limit $goto,$pagesize";
