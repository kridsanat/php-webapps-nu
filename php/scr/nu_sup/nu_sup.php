		...
		<TABLE width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
			...
			<tr valign="center"> 
				...
				<td width="40%">
						...
						<font color="#000000" size="4">Presently Page : <strong>WAN-IP & Production SubDomain Management</strong></font>
...
$sql_select_mem = "SELECT * FROM nu_sup WHERE infono LIKE '%$infono_filter%' ORDER BY infono, info5, info4 ASC LIMIT $goto, $pagesize";
...
if (mysqli_num_rows($fect) == 0) {
    ...
    echo "<table border='1' width='90%' align='center' cellspacing='1' cellpadding='1' >
            <tr>
				...
				<th width='233' ><font face= 'tahoma' color='#27408B' size='1'>WAN</font></th>
                    ...
                    <form method='post' action='nu_supedit.php?SerID=" . $idx . "' >
                        ...
                        <td>
                            <font face= 'tahoma' color='#000000' size='3'>&nbsp;&nbsp;<input name='submit' type='submit' class='submit' value='Edit' >
                                &nbsp;&nbsp;" . $info4 . " &nbsp;&nbsp;    <font face='tahoma' color='#000000' size='3'>
        &nbsp;&nbsp;<input name='submit' type='submit' class='submit' value='Edit'>
        &nbsp;&nbsp;<?= $info4; ?> 
        &nbsp;&nbsp;<span style="color: <?= $colorStatus; ?>;"><b><?= $status; ?></b></span>
    </font>
                            </font>
                        </td>
