...
$select_type="select * from nu_sup order by infono, info1 asc";
...
echo "<br><br><center><font color=#666666 face=tahoma size=2><b>No item</b></font></center>";
		...
		$select="select * from nu_sup order by infono, info1 asc";
...
$sql_select_mem="Select * From nu_sup order by infono, info1 asc limit $goto,$pagesize";
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			?>
							...
							&nbsp;<a href="nu_delsup.php?SerID=<?php echo "$idx"; ?>" onclick="return confirm('Are you sure?')" ><img src="../images/icon_close.jpg" alt="ลบข้อมูล" width="" height="" border="0" ></a></div>
								...
								<td>	
								&nbsp;&nbsp;	
									<font width="1%" face="tahoma" size="2" color="#3e3d36">
